        ...
        tweets : [
            {
                ...
                TweetReplies : [
                    ...
                    {
                        name : 'Bipul',
                        handlerName : '@Bipul546',
                        tweetReplyText : 'Lorem Ipsum has been the industrys'
                    },
        ...
        tweets : [
            {
                ...
                TweetReplies : [
                    {
                        name : 'Suresh',
                        handlerName : '@Suresh123',
                        tweetReplyText : 'I love to spend time in jungle'
                    },
                    {
                        name : 'Ramesh',
                        handlerName : '@Ramesh12345',
                        tweetReplyText : 'i want to explore jungle and i goes jungle atlist one time in a year '
                    },
        ...
        tweets : [
           ...
           tweetPic : 'https://lh3.googleusercontent.com/9qfuVqMrGUGsmOWlloXw9xqonA1btjoBRVFGMZxIZkYANGZGoQpeQuCVSVxAQYjggYOT8kyTlsf-I4I2Ar4-izKrH8Gps7xDNq_9GJ4QyI5tERgrWH2HgB7bt1Cp65UfkZwVrpcC9A=w1920-h1080',
                ...
                TweetReplies : [
                    {
                        name : 'Hariom',
                        handlerName : '@Hariom123',
                        tweetReplyText : 'Rajasthan goverment should take Strict action on Education and goverment Teacher'
                    },
                    {
                        name : 'Kunal',
                        handlerName : '@Kunal123',
                        tweetReplyText : 'Rajasthan goverment spoiled student Carreer and its not acceptable'
                    },
                ...
                TweetReplies : [
                    {
                        name : 'Raviraj',
                        handlerName : "@Raj1223",
                       tweetReplyText     : 'Free education is oppurtunity for those who is financially week',
                    },
                    {
                        name : 'Sunil',
                        handlerName : '@Sunil123',
                        tweetReplyText : 'Free Education is a great Revolution'
                    },
                ...
                TweetReplies : [
                    {
                        name : 'Kunal',
                        handlerName : '@Kunal123',
                        tweetReplyText : 'Make in India'
                    },
                    {
                        name : 'Sachin',
                        handlerName : '@Sachin456',
                        tweetReplyText : 'Make in India is a great Initiative'
                    },
         ...
         My installation Sand Art at Puri beach in Odisha.`,
           tweetPic : 'https://lh3.googleusercontent.com/mTTckc-jkREvxkSdJAdrDXlRb6rSl0yP4DAUwXbMg1jzWclpLBhp7LNEDs2kIAd70tD25DSoOjbxJvPdrbLrMdEtcIa-xwt7srCZ1CDtGyysE5F8Y3Txo-ZKSMJekFC5U6ZNLJxPkA=w1920-h1080',
                ...
                TweetReplies : [
                    {
                        name : 'Kishan',
                        handlerName : 'Kishan@123',
                        tweetReplyText : 'Subhas Chandra Bose was a Great person '
                    },
                    {
                        name : 'Mohan',
                        handlerName : 'Mohan@321',
                        tweetReplyText : 'What a sandArt it is great Talent'
                    },
          ...
          But today, India is moving ahead on the path of sustainable development managing 
           ...
           tweetPic : 'https://lh3.googleusercontent.com/gt2P-cr6YN3T1bBsebU90SaZHJGZ1V2cfkb-bLvHu2MDYYt_69e-nkr-Ih6TLG1AB9YRLspbZLHPuUdrMOybhcRKnCzQlox5Mf6UPdm9CLqkNyRiC3iSYSs_MlZLDfCJBP1QX2UUAg=w1920-h1080',
                ...
                TweetReplies : [
                    {
                        name : 'Sudarshan',
                        handlerName : '@Sudarshan123',
                        tweetReplyText : 'Yes you are saying absolutely right'
                    },
                    {
                        name : 'Amit',
                        handlerName : '@Amit321',
                        tweetReplyText : 'Great revolution'
                    },
